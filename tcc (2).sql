...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 22-Ago-2024 às 17:31
...
INSERT INTO `enderecos` (`id_endereco`, `id_evento`, `cep`, `rua`, `numero`, `bairro`, `cidade`, `estado`) VALUES
(13, 37, 4643643, 'general camara', 4643, 'Vila julia', 'Uruguaiana', 'RS'),
(19, 43, 4643643, 'general camara', 4643, 'Vila julia', 'Uruguaiana', 'RS'),
(20, 44, 4643643, 'general camara', 4643, 'Vila julia', 'Uruguaiana', 'RS');
...
(2, 'emp_Lazzarus', 'lazaro.2022315968@aluno.iffar.edu.br', '$argon2i$v=19$m=65536,t=4,p=1$M3IyWnNsTVlyeUI1d0EzbA$s9BRI5uh5IGOFClxCdkIf0p6toNzbRNi4W+GsS5201g', 3, 2);
